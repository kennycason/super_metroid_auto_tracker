...
export class GameStateParser {
  ...
  private parseBosses(
    ...
    bossPlus1Data: Uint8Array | null,
    bossPlus2Data: Uint8Array | null,
    bossPlus3Data: Uint8Array | null,
    bossPlus4Data: Uint8Array | null,
    _bossPlus5Data: Uint8Array | null,
    escapeTimer1Data: Uint8Array | null,
    escapeTimer2Data: Uint8Array | null,
    escapeTimer3Data: Uint8Array | null,
    escapeTimer4Data: Uint8Array | null,
    locationData: Record<string, any>,
    shipAiData: Uint8Array | null = null,
    eventFlagsData: Uint8Array | null = null
  ): Record<string, boolean> {
    ...
    return {
      ...
      samus_ship: this.detectSamusShip(                     // End-game detection
        ...
        locationData,
        motherBrainDefeated,
        this.motherBrainPhaseState.mb1_detected,
        this.motherBrainPhaseState.mb2_detected
      )
    };
  }
  ...
  private detectSamusShip(
    shipAiData: Uint8Array | null,
    eventFlagsData: Uint8Array | null,
    locationData: Record<string, any>,
